  ...
  return (
    <section className="h-screen bg-amber-400">
      <div className="relative w-full min-h-screen ">
        ...
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-black/70 via-black/50 to-transparent min-h-screen"></div>
        ...
        >
          <div className=" h-full justify-center items-start flex flex-col  mt-[6.75rem]">
            ...
            <div className="py-8 text-center md:text-start text-white text-sm md:text-base font-medium max-w-3xl leading-relaxed">
